...
#define		PRODUCT_KEY														"426faccf5eaf4300b9840a82150d2d25"//"07b24913b07f4b38b8bafeac1dd1d7e2"//"6f3074fe43894547a4f1314bd7e3ae0b"
...
{
	pro_headPart				head_part;  //8B
	uint8_t							sub_cmd;    //action
	uint8_t							cmd_tag;    //attr_flag
	status_writable			status_w;   //attr_val
	uint8_t							sum;        //sum
};
